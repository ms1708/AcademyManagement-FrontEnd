...
export const routes: Routes = [
  ...
  // Authentication routes
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/auth/email-verification/email-verification.component').then(
    ...
    children: [
      {
        path: 'step1',
        loadComponent: () =>
          import('./features/onboarding/onboarding-step1/onboarding-step1.component').then(
      ...
      },
      {
        path: 'step2',
        loadComponent: () =>
          import('./features/onboarding/onboarding-step2/onboarding-step2.component').then(
      ...
      },
      {
        path: 'step3',
        loadComponent: () =>
          import('./features/onboarding/onboarding-step3/onboarding-step3.component').then(
  ...
  // Student Portal (Builder.io version)
  {
    path: 'student-portal',
    loadComponent: () =>
      import('./features/student-portal/student-portal/student-portal.component').then(
